...
var SRC_JS = [
    ...
    'src/faculty/events/create-faculty-with-detail.event.js',
    ...
    'src/faculty/events/open-create-faculty-form-dialog.event.js',
    'src/faculty/events/open-edit-faculty-form-dialog.event.js',
    'src/faculty/events/validate-faculty-id.event.js',
    'src/faculty/form-dialog/create-form-dialog.controller.js',
    'src/faculty/form-dialog/edit-form-dialog.controller.js',
