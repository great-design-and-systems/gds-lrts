(function() {
	...
	function FacultyResourceService($resource, API_HOST, FACULTY_CONTEXT) {
		var resource = $resource(API_HOST + FACULTY_CONTEXT, {}, {
			...
			createFaculty : {
				method : 'POST',
				url : API_HOST + FACULTY_CONTEXT + 'create'
			},
			updateFaculty : {
				method : 'PUT',
				url : API_HOST + FACULTY_CONTEXT + 'update?param=facultyId::facultyId',
				params : {
					facultyId : '@facultyId'
				}
			},
			deleteFaculty : {
				method : 'DELETE',
				url : API_HOST + FACULTY_CONTEXT + 'delete?param=facultyId::facultyId',
				params : {
					facultyId : '@facultyId'
				}
			},
