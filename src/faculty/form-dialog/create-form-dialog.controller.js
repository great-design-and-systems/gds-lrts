(function () {
    'use strict';
    angular.module('app.faculty').controller('FacultyCreateFormController', FacultyCreateFormController);
    FacultyCreateFormController.$inject = ['DownloaderService', 'EventEmitterService', 'UploadEvents', '$scope', 'FileEvents', 'FacultyEvents'];
    function FacultyCreateFormController(DownloaderService, EventEmitterService, UploadEvents, $scope, FileEvents, FacultyEvents) {
        var createForm = this;
        ...
        function save() {
            EventEmitterService.emit(FacultyEvents.CREATE_FACULTY_DETAIL, createForm.data, function (err) {
                if (!err) {
                    createForm.hide();
                } else {
                    console.log('err', err);
