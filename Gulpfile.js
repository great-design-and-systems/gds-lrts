...
var FILE_CONTEXT = process.env.FILE_CONTEXT || '/gds/fileServicePort/';
var LOGIN_CONTEXT = process.env.LOGIN_CONTEXT || '/gds/login/';
var USER_CONTEXT = process.env.USER_CONTEXT || '/gds/authenticationServicePort/';
var SECURITY_CONTEXT = process.env.SECURITY_CONTEXT || '/gds/authenticationServicePort/';
